            ...
            <main className="flex-grow flex flex-col items-center relative pt-28">
                ...
                <div className="max-w-6xl w-full flex flex-col px-6 relative z-10">
                    ...
                    <div className="mb-10">
                        ...
                        >
                            <p className="text-[10px] text-[#2DD4BF] font-black uppercase tracking-[0.25em] mb-2">{getGreeting()}</p>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
                        {/* Archive Size Card */}
                        <motion.div
                            className="bg-card rounded-[2rem] p-8 shadow-xl border border-border-custom flex items-center justify-between group hover:border-primary/30 hover:shadow-2xl transition-all duration-500"
                        ...
                        >
                            <div className="relative z-10">
                                ...
                                <p className="text-4xl font-black text-foreground leading-none tracking-tighter">{thesisCount.toLocaleString()}</p>
                                <p className="text-[10px] text-primary font-black uppercase tracking-[0.1em] mt-3">Theses Indexed</p>
                            </div>
                            <div className="w-16 h-16 rounded-2xl bg-primary/5 flex items-center justify-center border border-primary/20 group-hover:bg-primary group-hover:border-primary transition-all duration-500">
                                <FaSearch className="text-2xl text-primary group-hover:text-background transition-all duration-500" />
                            </div>
                        </motion.div>

                        {/* AI History Count Card */}
                        <motion.div
                            className="bg-card rounded-[2rem] p-8 shadow-xl border border-border-custom flex items-center justify-between group hover:border-purple-200 hover:shadow-2xl transition-all duration-500"
                            initial={{ opacity: 0, y: 20 }}
                            animate={{ opacity: 1, y: 0 }}
                        ...
                        >
                            <div className="relative z-10">
                                ...
                                <p className="text-4xl font-black text-foreground leading-none tracking-tighter">{aiHistory.length}</p>
                                <p className="text-[10px] text-primary font-black uppercase tracking-[0.1em] mt-3">Recommendations</p>
                            </div>
                            <div className="w-16 h-16 rounded-2xl bg-card/40 flex items-center justify-center border border-border-custom group-hover:bg-purple-600 group-hover:border-purple-600 transition-all duration-500">
                        ...
                        <motion.div
                            className="bg-card rounded-[2rem] p-8 shadow-xl border border-border-custom flex items-center justify-between group hover:border-orange-200 hover:shadow-2xl transition-all duration-500"
                            initial={{ opacity: 0, y: 20 }}
                            animate={{ opacity: 1, y: 0 }}
                        ...
                        >
                            <div className="relative z-10">
                                ...
                                <p className="text-4xl font-black text-foreground leading-none tracking-tighter">{recentTheses.length}</p>
                                <p className="text-[10px] text-primary font-black uppercase tracking-[0.1em] mt-3">Active Items</p>
                            </div>
                            <div className="w-16 h-16 rounded-2xl bg-card/40 flex items-center justify-center border border-border-custom group-hover:bg-card/400 group-hover:border-orange-500 transition-all duration-500">
                    ...
                    <div className="space-y-12 mb-24">
                        ...
                        <div className="w-full space-y-8">
                                ...
                                <div className="flex items-center gap-3">
                                    {aiHistory.length > 0 && (
                                        <button 
                                            ...
                                            className="text-[10px] font-black uppercase tracking-widest text-primary bg-primary/5 border border-primary/30 px-4 py-1.5 rounded-full transition-all duration-300 hover:bg-primary/20 hover:border-primary/50 hover:shadow-[0_0_15px_rgba(45,212,191,0.1)] active:scale-95"
                                        >
                                            Clear History
                                        </button>
                                    )}
                            ...
                            <div className="bg-card rounded-[2.5rem] border border-border-custom shadow-xl overflow-hidden">
                                {loadingAi ? (
                                    ...
                                    <div className="divide-y divide-gray-50">
                                        {aiHistory.slice(0, 5).map((item) => {
                                            return (
                                                <div key={item._id} className="p-8 hover:bg-surface transition-colors group relative">
                                                    <div className="flex flex-col md:flex-row md:items-start justify-between gap-6">
                                                        <div className="flex-1 w-full">
                                                            ...
                                                            >
                                                                <div className={`w-8 h-8 rounded-lg flex items-center justify-center transition-colors bg-gray-100 text-gray-400 group-hover/title:bg-card/40 group-hover/title:text-primary`}>
                                                                    <FaRobot />
                                                                </div>
                                                                <div className="flex-1">
                                                                    <h3 className="text-sm font-black text-foreground tracking-tight group-hover/title:text-blue-600 transition-colors flex items-center gap-2">
                                                        ...
                                                        <div className="flex-shrink-0 flex items-start pt-1">
                                                            <button
                                                                ...
                                                                className="text-gray-300 hover:text-primary hover:bg-teal-50 p-3 rounded-xl transition-all"
                                        ...
                                        {aiHistory.length > 5 && (
                                            <div className="p-4 bg-surface/50 text-center">
                                                <button className="text-[10px] font-black text-gray-400 uppercase tracking-widest hover:text-[#2DD4BF] transition-colors">
                                                    View All History
                                                </button>
                                            </div>
                                        )}
                                    ...
                                    <div className="p-12 text-center flex flex-col items-center justify-center">
                                        <div className="w-16 h-16 bg-card/40 rounded-full flex items-center justify-center mb-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div>
                                <div className="flex items-center justify-between mb-6">
                                    <h2 className="text-xs font-black text-white tracking-[0.2em] uppercase flex items-center gap-3">
                                        <span className="w-1.5 h-6 bg-card/400 rounded-full" />
                                        Recent Views
                                    </h2>
                                ...
                                <div className="bg-card rounded-[2rem] p-8 shadow-xl border border-border-custom text-foreground relative overflow-hidden group">
                                    <div className="relative z-10 space-y-6">
                                        {recentTheses.length > 0 ? (
                                            recentTheses.slice(0, 3).map((thesis) => (
                                                ...
                                                >
                                                    <p className="text-[9px] text-primary font-black uppercase tracking-widest mb-1">{thesis.year || 'No Year'}</p>
                                                    <h3 className="text-[13px] font-bold leading-tight line-clamp-2 group-hover/item:text-teal-700 transition-colors">{thesis.title}</h3>
                                                    <div className="w-6 h-0.5 bg-border-custom mt-3 group-hover/item:w-full group-hover/item:bg-teal-200 transition-all duration-500" />
                                                </div>
                                            ))
                                        ) : (
                            ...
                            <div>
                                <h2 className="text-xs font-black text-white tracking-[0.2em] uppercase flex items-center gap-3 mb-6">
                                    <span className="w-1.5 h-6 bg-[#2DD4BF] rounded-full" />
                                    Archive Stats
                                </h2>
                                <div className="bg-card rounded-[2.5rem] border border-border-custom shadow-xl p-6">
                                    <div className="space-y-4">
                                        {deptCounts.slice(0, 5).map((dept, idx) => (
                                            <div
                                                key={dept.category + idx}
                                                className="flex items-center justify-between p-4 rounded-xl hover:bg-surface transition-colors cursor-pointer group"
                                                onClick={() => router.push(`/search_result?category=${encodeURIComponent(dept.category)}`)}
                                            >
                                                <span className="text-[10px] font-black text-text-dim uppercase tracking-widest group-hover:text-primary transition-colors">{dept.category}</span>
                                                <span className="text-sm font-black text-foreground">{dept.count}</span>
                                            </div>
                                        ))}
                                    </div>
                                </div>
            ...
            {/* Delete Confirmation Modal */}
            {
                deleteModalOpen && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm animate-fade-in">
                        <motion.div
                            className="bg-card rounded-3xl p-8 w-full max-w-sm shadow-2xl relative overflow-hidden"
                        ...
                        >
                            ...
                            <div className="relative z-10 flex flex-col items-center text-center">
                                ...
                                <h3 className="text-xl font-black text-foreground mb-2">Delete Recommendation?</h3>
                                <p className="text-sm text-text-dim font-medium mb-8">
                                ...
                                <div className="flex w-full gap-3">
                                    <button
                                        ...
                                        className="flex-1 bg-gray-100 hover:bg-border-custom text-foreground font-bold py-3 rounded-xl transition-colors text-sm"
                                    >
                                        Cancel
                                    </button>
                                    <button
                                        onClick={confirmDeleteAiHistory}
                                        className="flex-1 bg-primary/5 border border-primary/30 text-primary font-black text-[11px] uppercase tracking-[0.2em] py-3 rounded-xl transition-all duration-300 shadow-lg hover:bg-primary/20 hover:border-primary/50 hover:shadow-[0_0_20px_rgba(45,212,191,0.15)] active:scale-95 active:bg-primary/30"
                                    >
                                        Delete
                                    </button>
                                </div>
                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm animate-fade-in">
                        ...
                        >
                            ...
                            <div className="relative z-10 flex flex-col items-center text-center">
                                ...
                                <h3 className="text-xl font-black text-foreground mb-2">Clear All History?</h3>
                                <p className="text-sm text-text-dim font-medium mb-8">
                    ...
                    <div className="bg-card rounded-[2.5rem] p-8 md:p-12 w-full max-w-3xl max-h-[85vh] overflow-hidden flex flex-col shadow-2xl relative">
                        ...
                        <div className="flex items-center gap-4 mb-8 flex-shrink-0 relative z-10">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-text-dim font-bold uppercase tracking-widest">Tailored to: "{selectedAiItem.prompt}"</p>
                            </div>
                        </div>
                        ...
                        <div className="mt-8 flex justify-end flex-shrink-0 relative z-10">
                            <button
                                ...
                                className="flex items-center gap-3 px-8 py-3.5 rounded-2xl text-[11px] font-black tracking-[0.2em] uppercase transition-all duration-300 shadow-lg hover:bg-primary/20 hover:border-primary/50 hover:shadow-[0_0_20px_rgba(45,212,191,0.15)] active:scale-95 bg-primary/5 text-primary border border-primary/30"
                            >
