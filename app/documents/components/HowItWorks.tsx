    ...
    return (
        <section className="relative px-6 max-w-5xl mx-auto mb-20 z-10 animate-fade-in" style={{ animationDelay: '0.2s' }}>
            <div className="text-center mb-12">
                ...
                <div className="w-12 h-1 bg-[#8b0000] mx-auto rounded-full" />
            </div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {[
                    {
                        icon: <FaFileAlt className="text-2xl text-[#fecaca]" />,
                    ...
                    {
                        icon: <FaBrain className="text-2xl text-[#fecaca]" />,
                    ...
                    {
                        icon: <FaSearch className="text-2xl text-[#fecaca]" />,
                    ...
                    <div key={i} className="bg-white/5 backdrop-blur-md border border-white/10 p-8 rounded-[2rem] hover:bg-white/10 transition-all group shadow-sm hover:shadow-xl hover:shadow-[#8b0000]/5">
                        <div className="mb-6 bg-white/5 w-14 h-14 rounded-2xl flex items-center justify-center border border-white/10 group-hover:scale-110 transition-transform">
                            {item.icon}
                        </div>
                        ...
                        <div className="text-[9px] font-black uppercase tracking-widest text-[#fecaca] opacity-60">
                            {item.tech}
                        </div>
                    </div>
                ))}
