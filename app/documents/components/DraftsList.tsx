            ...
            <div className="grid grid-cols-1 gap-4 max-h-[700px] overflow-y-auto pr-2 custom-scrollbar">
                {drafts.map((draft) => (
                    <div 
                        ...
                        className="group bg-white/5 backdrop-blur-md border border-white/10 p-5 rounded-3xl hover:bg-white/10 hover:border-white/20 transition-all cursor-pointer relative overflow-hidden flex items-center gap-5"
                    >
                        <div className="w-12 h-12 bg-white/5 rounded-2xl flex items-center justify-center text-white/40 group-hover:text-amber-400 group-hover:bg-amber-400/10 transition-all">
                        ...
                        <div className="p-3 bg-white/5 rounded-xl text-white/20 group-hover:text-white group-hover:bg-[#8b0000] transition-all">
